...
<p style="font-size:30px;text-align:center"> <a href="cregister">我要发布项目，点击这里注册</a></p>
<p style="font-size:30px;text-align:center"> <a href="sregister">我是开发者，点击这里注册</a></p>
...
<body>
	...
	<div
		...
		<form id="phoneForm" method="post" autocomplete="off" role="form"
			action="javascript:doPhoneRegister()">
				...
				<div
					...
					<div
						...
						<div class="col-xs-10 col-lg-10">
							<input class="form-input input-color" name="phoneNumber"
								id="phoneNumber" placeholder="手机号" required="true"
								minlength="11" maxlength="11" isMobilePhoneNumber="true"
								phoneNumExisting="true" />
						</div>
					</div>
					<span
				...
				<div class="col-lg-12 col-md-12 form-group-height">
					<div
						...
						<div class="col-xs-8 col-md-8">
							<input class="form-input input-color" name="phonePasswd"
								id="phonePasswd" placeholder="密码" minlength="6" required />
						</div>
					</div>
					<span
						class="col-lg-offset-1 col-xs-offset-1 col-lg-10 col-xs-10 msgspan"
						id="phonePasswdMsg"></span>
				</div>
				...
				<div
					...
					<div class="btn-height">
						<button type="submit" id="btnSubmit"
							class="btn btn-primary btn-submit btn-submit-style">注册</button>
						<span class="col-lg-offset-1 col-lg-10 col-xs-10 msgspan"
							id="phoneRegisterMessage"></span>
					</div>
					<div class="text-center">
