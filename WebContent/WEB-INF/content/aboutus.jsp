...
<link href="https://www.make8.com/css/about.css?v=201608241757"
	rel="stylesheet" type="text/css">
</head>
...
<body>
	...
	<div class="col-xs-12 aboustUs-body"
		style="padding: 0px; background: url(https://static.make8.com/img/about/aboutusBg.jpg) no-repeat; background-position: center; background-size: cover;">
		...
		<div class="container">
			<div class="col-xs-12 about-blur">
				...
				<div class="col-xs-12">
					<div class="col-xs-12 col-sm-4 text-center about-blur-div"
						onclick="window.open('http://www.make8.com')">
						<img class="img_pc active"
							src="https://static.make8.com/img/about/make8.png" /><img
							class="img_m"
							src="https://static.make8.com/img/about/make8_m.png" />
					</div>
					<div class="col-xs-12 col-sm-4 text-center about-blur-div"
						onclick="window.open('http://www.yunweipai.com')">
						<img class="img_pc active"
							src="https://static.make8.com/img/about/yunweipai.png" /><img
							class="img_m"
							src="https://static.make8.com/img/about/yunweipai_m.png" />
					</div>
					<div class="col-xs-12 col-sm-4 text-center about-blur-div"
						onclick="window.open('http://www.chengxuyuan.com')">
						<img class="img_pc active"
							src="https://static.make8.com/img/about/chengxuyuan.png" /><img
							class="img_m"
							src="https://static.make8.com/img/about/chengxuyuan_m.png" />
					</div>
				</div>
			</div>
		</div>
