...
<link rel="stylesheet"
	href="https://www.make8.com/css/home/request_handle.css?v=201608241757">
</head>
...
<body>
			...
			<div class="modal-content">
				<div class="modal_title chooseRoleFunctionTitle">
					<div class="col-md-6 col-sm-6 col-xs-6">
						<img src="https://static.make8.com/img/Feedback_icon.png"
							style="width: 25px; height: 25px;" alt="" /> <span>进展反馈</span>
					</div>
					<div class="col-md-6 col-sm-6 col-xs-6 text-right">
						<img data-dismiss="modal" style="cursor: pointer;"
							src="https://static.make8.com/img/project_functions_cancle.png"
							alt="" />
					</div>
				</div>
				<div class="modal_body_functions">
					<form action="javascript:createProgressFeedback()"
						id="progressFeedbackForm">
						...
						<div class="col-xs-12 col-md-12 col-sm-12">
							<div class="col-md-12 col-sm-12 col-xs-12 padding-right">
								<div class="col-md-12 col-sm-12 col-xs-12 padding"
									...
									<span style="color: red;">*</span>进展反馈(至少10个字)
								</div>
								<div class="col-md-12 col-sm-12 col-xs-12 padding">
									<textarea class="form-control plan_textarea" id='monitorDesc'
							...
							<div class="col-md-12 col-sm-12 col-xs-12"
								style="margin: 15px auto;">附件</div>
							<div class='col-md-12 col-xs-12 col-sm-12 padding-right'>
								<input id="fileselect-monitor" name="pic" class="picselect file"
									type="file"></input>
							</div>
							<div class='col-md-12 fileupload-info-box'>
								<div class="col-md-10 project-handle-item-content padding-left"
									style="margin-left: 0px;">
									<div id='monitorFileInfo'
										class="alert alert-danger alert-dismissible fileupload-info"
										role="alert">
										<button type="button" class="close">
											<span aria-hidden="true" class='info-close'>&times;</span>
										</button>
										<strong>错误!</strong><span class='info'></span> <img
											id="tempimg" dynsrc="" src="" style="display: none" />
									</div>
								</div>
								<div class='col-md-12' style="margin-left: 0px;">
									<div
										class="col-md-12 col-sm-12 col-xs-12 padding project-handle-item-content">
							...
							<div class='col-md-12 col-xs-12 col-sm-12'>
								<div id='monitorFileList'
									class="col-md-10 project-handle-item-content file-list padding-left"
									...
									<div class="btn-group attach-group attach-model">
										...
										<button type="button"
											class="btn btn-primary btn-xs attach-del">
											<span class="fa fa-times"></span> <span class="sr-only">Toggle
												Dropdown</span>
										</button>
									</div>
									<!--附件模型end-->
							...
							<!-- footer-->
							<div
								class="col-md-12 col-xs-12 col-sm-12 padding-right functionMarginTop">
								<div class="col-md-5 col-sm-5 col-xs-5 text-left padding">
									<input type="button" value="取消" data-dismiss="modal"
										class="btn btn-cancel btn-functions btn-cancel-functions" />
								</div>
								<div
									class="col-md-offset-2 col-sm-offset-2 col-xs-offset-2 col-md-5 col-sm-5 col-xs-5 text-right padding">
									<input type="submit" value="确定"
										class="btn btn-primary btn-functions" />
								</div>
							</div>
						</div>
					</form>
	...
	<div class="modal" id="plan">
		<div class="modal_plan">
			<div class="modal-content">
				<div class="modal_title chooseRoleFunctionTitle">
					<div class="col-md-6 col-sm-6 col-xs-6">
						<img src="https://static.make8.com/img/plan_icon.png"
							style="width: 25px; height: 25px;" alt="" /> <span>阶段计划</span>
					</div>
					<div class="col-md-6 col-sm-6 col-xs-6 text-right">
						<img data-dismiss="modal" style="cursor: pointer;"
							src="https://static.make8.com/img/project_functions_cancle.png"
				...
				<div class="modal_body_functions">
					<form action="javascript:createPlan()" id="planForm">
						<div class="col-xs-12 col-md-12 col-sm-12">
							<div
								class="col-md-12 col-sm-12 col-xs-12 padding-right plan_margin_top">
								<div class="col-md-6 col-sm-6 col-xs-6 padding">
									<div class="col-md-3 col-sm-3 col-xs-5 plan_title padding">
										<span style="color: red;">*</span>开始时间
									</div>
									<div
										class="input-group col-md-9 col-sm-9 col-xs-7 date planStartTime"
										style="padding: 0px 15px 0px 0px;" id="planStartTimeDiv">
										<input type="text" class="form-control form-input-small"
											id="planStartTime" required name="planStartTime" /> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-remove"></span></span> <span
											class="input-group-addon"><span class="fa fa-calendar"></span></span>
									</div>
									<div name="planStartTimeMsg" id="planStartTimeMsg"></div>
								</div>
								<div class="col-md-6 col-sm-6 col-xs-6 padding">
									<div
										class="col-md-3 col-sm-3 col-xs-5 plan_title padding text-right">
										<span style="color: red;">*</span>结束时间
									</div>
									<div
										class="input-group col-md-9 col-sm-9 col-xs-7 planEndTime date padding-right"
										style="padding: 0px 0px 0px 15px;" id="planEndTimeDiv">
										<input type="text" class="form-control" id="planEndTime"
											name="planEndTime" required checkTime="true" /> <span
											class="input-group-addon"><span
											class="glyphicon glyphicon-remove"></span></span> <span
											class="input-group-addon"><span class="fa fa-calendar"></span></span>
									</div>
									<div name="planEndTimeMsg" style="padding-left: 30px;"
										id="planEndTimeMsg"></div>
								</div>
							</div>
							...
							<div
								...
								<div class="col-md-6 col-sm-6 col-xs-6 padding">
									<div class="col-md-3 col-sm-3 col-xs-5 plan_title padding">
										<span style="color: red;">*</span>阶段状态
									</div>
								...
								<div class="col-md-6 col-sm-6 col-xs-6 padding">
									<div
										class="col-md-3 col-sm-3 col-xs-5 plan_title padding text-right">
										<span style="color: red;">*</span>阶段金额
									</div>
									<div class="col-md-9 col-sm-9 col-xs-7 padding-right">
										<input type="text" name="price" id="price"
											class="form-control" required checkPrice="true" />
									</div>
							...
							<div
								...
								<div class="col-md-6 col-sm-6 col-xs-6 padding">
									<div class="col-md-3 col-sm-3 col-xs-5 plan_title padding">
										<span style="color: red;">*</span>阶段执行者
									</div>
									<div class="col-md-9 col-sm-9 col-xs-7 padding-left">
								...
								<div class="col-md-6 col-sm-6 col-xs-6 padding isDelay">
									<div
										class="col-md-3 col-sm-3 col-xs-5 plan_title padding text-right">
										<span style="color: red;">*</span>是否延期
									</div>
									<div class="col-md-9 col-sm-9 col-xs-7 padding-right">
										<select id="isDelay" class="form-control" name="isDelay"
											required>
							...
							<div
								class="col-md-12 col-sm-12 col-xs-12 padding plan_margin_top">
								...
								<div class="col-md-12 col-xs-12 col-xs-12 padding-right">
									<textarea id="describe" name="describe"
										class="form-control plan_textarea" required minlength="10"></textarea>
								</div>
							</div>
	...
	<div class="modal" id="functionChoice">
		<div class="modal_dialog">
			<div class="modal-content">
				<div class="modal_title chooseRoleFunctionTitle">
					<div class="col-md-6 col-sm-6 col-xs-6">
						<img src="https://static.make8.com/img/projectRole.png"
							style="width: 25px; height: 25px;" alt="" /> <span>选择角色</span>
					</div>
					<div class="col-md-6 col-sm-6 col-xs-6 text-right">
						<img data-dismiss="modal" style="cursor: pointer;"
							src="https://static.make8.com/img/project_functions_cancle.png"
				...
				<div class="modal_body_functions">
					<form action="javascript:addChosenDev()" id="functionChoiceForm">
						<div class="col-xs-12 col-md-12 col-sm-12">
							<div class="col-md-4 col-sm-4 col-xs-6">
								<div class="functions" value="1" onclick="choosefunctions(this)">项目经理</div>
							</div>
							<div class="col-md-4 col-sm-4 col-xs-6">
								<div class="functions" value="2" onclick="choosefunctions(this)">产品经理</div>
							</div>
							<div class="col-md-4 col-sm-4 col-xs-6">
								<div class="functions" value="3" onclick="choosefunctions(this)">UI设计</div>
							</div>
							<div class="col-md-4 col-sm-4 col-xs-6">
								<div class="functions" value="4" onclick="choosefunctions(this)">前端开发</div>
							</div>
							<div class="col-md-4 col-sm-4 col-xs-6">
								<div class="functions" value="5" onclick="choosefunctions(this)">后端开发</div>
							</div>
							<div class="col-md-4 col-sm-4 col-xs-6">
								<div class="functions" value="6" onclick="choosefunctions(this)">测试</div>
							</div>
							<div class="col-md-4 col-sm-4 col-xs-6">
								<div class="functions" value="7" onclick="choosefunctions(this)">架构师</div>
							</div>
							<div class="col-md-4 col-sm-4 col-xs-6">
								<div class="functions" value="8" onclick="choosefunctions(this)">DBA</div>
							</div>
							<div class="col-md-4 col-sm-4 col-xs-6">
								<div class="functions" value="9" onclick="choosefunctions(this)">全栈</div>
							</div>
					...
					<div class id="functionChoiceMsg"
						style="display: none; color: red; padding: 0px 30px; margin-top: 10px;">至少选择一个角色职能</div>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="modal_dialog">
			<div class="modal-content">
				<div class="modal_title chooseRoleFunctionTitle">
					<div class="col-md-6 col-sm-6 col-xs-6">
						<img src="https://static.make8.com/img/Feedback_icon.png"
							style="width: 25px; height: 25px;" alt="" /> <span>进度日志</span>
					</div>
					<div class="col-md-6 col-sm-6 col-xs-6 text-right">
						<img data-dismiss="modal" style="cursor: pointer;"
							src="https://static.make8.com/img/project_functions_cancle.png"
					...
					<form action="javascript:addLog()" id="addLogDivForm">
						<div class="col-xs-12 col-md-12 col-sm-12">
							<div class="col-md-12 col-sm-12 col-xs-12 openObj">
								<div class="col-md-12 col-sm-12 col-xs-12 padding logDiv_title">
									<span style="color: red;">*</span>公开对象
								</div>
								<div class="col-md-8 col-sm-8 col-xs-8 padding">
									<select class="form-control" id="objectOriented"
										name="objectOriented" required>
							...
							<div class="col-md-12 col-sm-12 col-xs-12 logContent">
								<div class="col-md-12 col-xs-12 col-sm-12 padding logDiv_title">
									<span style="color: red;">*</span>日志内容(至少输入5个字)
								</div>
								<div class="col-md-12 col-sm-12 col-xs-12 padding">
									<textarea style="resize: none; height: 160px;" minlength="5"
										class="form-control" id="journalContent" name="journalContent"
										required></textarea>
								</div>
							</div>
							<div class="col-md-12 col-xs-12 col-sm-12">
								<div class="col-md-6 col-sm-6 col-xs-6 text-left padding">
									<input id="addLogDivCancle" type="button" value="取消"
										data-dismiss="modal" class="btn btn-cancel" />
								</div>
	...
	<div class="container body">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="col-md-4 col-sm-4 col-xs-12 projectInfo">
				...
				<div class="col-md-12 col-sm-12 col-xs-12 padding projectMsg">
					<div class="col-md-12 col-sm-12 col-xs-12 padding projectMsgDiv">
						项目雇主： <span class="projectMsgSpan"> 15504638550 </span>
					</div>
					<div class="col-md-12 col-sm-12 col-xs-12 padding projectMsgDiv">
						项目类型：<span class="projectMsgSpan">Andriod / 其他</span>
					</div>
					<div class="col-md-12 col-sm-12 col-xs-12 padding projectMsgDiv">
						项目预算：<span class="projectMsgSpan">100-1000元</span>
					</div>
					<div class="col-md-12 col-sm-12 col-xs-12 padding projectMsgDiv">
						创建时间：<span class="projectMsgSpan">2017-11-05 22:52</span>
					</div>
					<div class="col-md-12 col-sm-12 col-xs-12 padding projectMsgDiv">
						项目周期：<span class="projectMsgSpan">1天</span>
					</div>
					<div class="col-md-12 col-sm-12 col-xs-12 padding projectMsgDiv">
						分配顾问：<span class="projectMsgSpan">顾问-大鱼</span>
					</div>
					<div class="col-md-12 col-sm-12 col-xs-12 padding projectMsgDiv">
						需要购买域名： <span class="projectMsgSpan"> 是 </span>
					</div>
					<div class="col-md-12 col-sm-12 col-xs-12 padding projectMsgDiv">
						需要购买云主机和数据库： <span class="projectMsgSpan"> 是 </span>
					</div>

					<input type="hidden" value="13572"> <input type="hidden"
						value="13572">
				</div>
			</div>
			<div
				class="col-md-8 col-sm-12 col-xs-12 projectStatusDiv padding-right">
				<div class="col-md-12 padding projectLabel">
					<div class="border-left"></div>
					<div>项目状态</div>
				</div>
				<div class="col-md-12 col-sm-12 col-xs-12 projectStatus">
					<img class="projectStatusImg"
						src="https://static.make8.com/img/m_request_handle_1.png" />
				</div>
			</div>
		</div>
		...
		<div class="col-md-12 col-sm-12 col-xs-12 projectDetails">
			...
			<div class="col-md-12 col-sm-12 col-xs-12 padding projectDetails_div">
				112322222222222222222222222222222222222222</div>
		</div>
				...
				<div class="col-md-8 col-sm-10 col-xs-12 padding-left">
					<div class="col-md-12">
						<div class="col-md-10 padding-left project-handle-item-content">
							<input id="fileselect" name="pic" class="picselect file"
								type="file"></input>
						</div>
					</div>
					<div class='col-md-12 fileupload-info-box'>
						<div class="col-md-10 padding-left project-handle-item-content">
							<div id='projectFileInfo'
								class="alert alert-danger alert-dismissible fileupload-info"
								role="alert">
								<button type="button" class="close">
									<span aria-hidden="true" class='info-close'>&times;</span>
								</button>
								<strong>错误!</strong><span class='info'></span> <img id="tempimg"
									dynsrc="" src="" style="display: none" />
							</div>
						</div>
					</div>
					<div class='col-md-12'>
					...
					<div class='col-md-12'>
						<div id='projectList'
							class="col-md-10 padding-left project-handle-item-content file-list padding-left"
							max='2'>
							<!--附件模型-->
							<div class="btn-group attach-group attach-model">
								<button type="button" class="btn btn-primary btn-xs attach">PrimaryPrimaryPrimary</button>
							...
							<input type='hidden' id="projectAttachment" class='attachment'
		...
		<div class="col-md-12 col-sm-12 col-xs-12 other">
			<div class="col-md-12 col-sm-12 col-xs-12 padding">
				...
				<div class="col-md-12 padding">
					<div class="col-md-12 col-sm-12 col-xs-12 padding">
						<div
							class="col-md-12 col-sm-12 col-xs-12 projectContactInformation">
							<div
								class="col-md-3 col-sm-6 col-xs-12 padding projectContactInformationDiv">
								<div>
									<img src="https://static.make8.com/img/user_icon.png" alt="" />
								</div>
								<div></div>
							</div>
							<div
								class="col-md-3 col-sm-6 col-xs-12 padding projectContactInformationDiv">
								<div>
									<img src="https://static.make8.com/img/phone_icon.png" alt="" />
								</div>
								<div>15504638550</div>
							</div>
							<div
								class="col-md-3 col-sm-6 col-xs-12 padding projectContactInformationDiv">
								<div>
									<img src="https://static.make8.com/img/mail_icon.png" alt="" />
								</div>
								<div></div>
							</div>
							<div
								...
								<div>
									<div>
										<img src="https://static.make8.com/img/qq_icon.png" alt="" />
									</div>
									<div></div>
								</div>
							</div>
			...
			<div class="col-md-12 col-sm-12 col-xs-12 padding">
				...
				<div class="col-md-12 col-sm-12 col-xs-12 padding">
					<div class="col-md-12 col-sm-12 col-xs-12 padding">
						<table class="col-md-12 col-sm-12 col-xs-12 padding journal"
							...
							<tr class="tableTr" onclick="showReasonForCompetence(this)">
								...
								<td class="text-center reasonForCompetence"><div
										class="reasonForCompetenceContent text-center">项目创建成功</div></td>
							</tr>
						</table>
						</table>
					</div>
			...
			<div class="modal-content">
				<form action="javascript:entryDevelopment()" id="checkAccount">
					...
					<div class="modal-body"
						...
						<div class="col-xs-12 ">
							<input id="proAccount" name="proAccount" type="text"
								class="form-control">
						</div>
						<p id="accountErr"></p>
					</div>
	...
	<!-- 模态框（雇主提交验收确认） -->
	<div class="modal fade" id="checkVerifyBox" tabindex="-1" role="dialog"
		aria-hidden="true">
		<div class="modal-dialog">
					...
					<div class="modal-body"
						...
						<div class="form-group col-xs-12">
							...
							<div class="col-xs-6 col-md-3 project-type"
								onclick="checkStatusRadio(this)">
								<div>
									<img class="project-type-img"
										src="https://www.make8.com/img/checkboxchecked.png" />
								</div>
								<p>通过</p>
							</div>
							<div class="col-xs-6 col-md-3 project-type"
								onclick="checkStatusRadio(this)">
								<div>
									<img class="project-type-img active" id="unPass"
										src="https://www.make8.com/img/checkboxchecked.png" />
								</div>
								<p>不通过</p>
							</div>
						...
						<div class="form-group col-xs-12">
							...
							<textarea style="resize: none; height: 120px;"
								class="form-control" id="checkRemark" name="checkRemark"></textarea>
