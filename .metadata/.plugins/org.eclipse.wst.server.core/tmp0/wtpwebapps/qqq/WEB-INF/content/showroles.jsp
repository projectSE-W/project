  	...
  	<div class="container">
	      <div class="col-lg-2 col-md-2 userInfo-left-nav">
            <ul class="list-group userInfo-service" id="userinfoNav">
                ...
                <a class="list-group-item" id="publishTheProject" href="safterloginbid">我投标的项目</a>
...
<a class="list-group-item" id="navOptions" href="scheckcontract">我的合同</a>
			...
			<s:iterator value="bookDetails">
		       <div class="col-md-12 phone">
		         <div class="col-md-3 col-md-offset-1">
		           ...
		           <br><label class="control-label form-label" for="phoneNumber"><i class="form-required"></i>项目名称</label>
		           
		         </div>
		         <div class="col-md-8">
		           <div class="col-lg-7 col-md-7">
		            <s:property value="sname"/></strong>
		            <p style="font-size:20px;">项目内容</p><s:property value="sname"/></strong>
		          	<p style="font-size:20px;">项目开始时间</p><s:property value="sname"/></strong>
		          	 <p style="font-size:20px;">项目结束时间</p><s:property value="sname"/></strong>
			...
			<div class="col-md-12 phone">
		         ...
		         <div class="col-md-8">
		           <div class="col-lg-7 col-md-7">
		           <s:iterator id="q" value="rolelist">
		            <p style="font-size:20px;">角色名称</p><s:property value="#q.rname"/></strong>
		            <p style="font-size:20px;">所属项目</p><s:property value="#q.pname"/></strong>
		            <p style="font-size:20px;">需要的技术</p><s:property value="#q.language"/></strong>
		          	<p style="font-size:20px;">要求的教育背景</p><s:property value="#q.education"/></strong>
		          	 <p style="font-size:20px;">所在地</p><s:property value="#q.city"/></strong>
		          	 <p style="font-size:20px;">需要人数</p><s:property value="#q.number"/></strong>
		          	 <p style="font-size:20px;">剩余数量</p><s:property value="#q.numberleft"/></strong>
		          	 <a href="scopc?rname=${rname}&pname=${pname}"><input type="button" value="申请角色"/></a>    	 
		          	 </s:iterator>
		          	 <input type="text" name="phoneNumber" id="phoneNumber" value="" class="form-control form-input" required minlength="11" maxlength="11" isMobilePhoneNumber="true" phoneNumExisting="true"/>
		           </div>
		         </div>
		       ...
		       <div class="col-md-12 weixin">
		         	...
		         	<div class="col-md-8">
		           		<div class="col-lg-7 col-md-7">
		           			<p style="font-size:20px;">姓名</p><s:property value="sname"/></strong>
