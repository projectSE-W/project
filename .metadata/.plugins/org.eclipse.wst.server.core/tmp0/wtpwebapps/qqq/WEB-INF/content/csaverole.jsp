	...
	<form action="saveroleAction" method="get" class="form-horizontal"
		...
		<fieldset>
			...
			<div class=" form-group form-group-a col-md-12">
				...
				<div class="col-md-10">
					<input type="text" class="form-control form-control-a"
						id="projectName" name="r.pno" placeholder="" required>
				</div>
			</div>
			<br>
			<div class="form-group form-group-a col-md-12">
				...
				<div class="text-center col-md-10">
					<input type="text" class="form-control form-control-a"
						id="projectDetail" name="r.pname" placeholder="" required>
				</div>
			</div>
			<br>
			<div class="form-group form-group-4-textarea col-md-12">
				...
				<div class="col-md-10">
					<textarea class="form-control form-textarea" rows="5"
						id="projectDesc" name="r.rno" placeholder="" required="true"
			...
			<div class="form-group form-group-4-textarea col-md-12">
				...
				<div class="col-md-10">
					<textarea class="form-control form-textarea" rows="5"
						id="projectDesc" name="r.rname" placeholder="" required="true"
						minlength="20" maxlength="1000"></textarea>
				</div>
			</div>
			<br>
			<div class="form-group form-group-4-textarea col-md-12">
				...
				<div class="col-md-10">
					<textarea class="form-control form-textarea" rows="5"
						id="projectDesc" name="r.number" placeholder="" required="true"
						minlength="20" maxlength="1000"></textarea>
				</div>
			</div>
			<br>
			<div class="form-group form-group-4-textarea col-md-12">
				...
				<div class="col-md-10">
					<textarea class="form-control form-textarea" rows="2"
						id="projectDesc" name="r.language" placeholder="" required="true"
						minlength="20" maxlength="1000"></textarea>
				</div>
			</div>
			<br>
			<div class="form-group form-group-4-textarea col-md-12">
				...
				<div class="col-md-10">
					<textarea class="form-control form-textarea" rows="5"
						id="projectDesc" name="r.education" placeholder="" required="true"
						minlength="20" maxlength="1000"></textarea>
				</div>
			</div>
			<br>
			<div class="form-group form-group-a col-md-12">
				...
				<div class="col-md-10">
					<input type="text" class="form-control form-control-a"
						id="projectName" name="r.city" placeholder="" required>
				</div>
			</div>
			<br>
