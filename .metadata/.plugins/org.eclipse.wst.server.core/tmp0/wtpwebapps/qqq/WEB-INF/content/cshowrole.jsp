...
<a class="list-group-item" id="publishTheProject" href="cpublish">发布项目</a>
			...
			<div class="col-md-12 phone">
		         ...
		         <div class="col-md-8">
		           <div class="col-lg-7 col-md-7">
		           <s:iterator id="u" value="rolelist">
		            <p style="font-size:20px;">角色名称</p><s:property value="#u.rname"/></strong>
		            <p style="font-size:20px;">所属项目</p><s:property value="#u.pname"/></strong>
		          	<p style="font-size:20px;">需要人数</p><s:property value="#u.number"/></strong>
		          	 <p style="font-size:20px;">剩余数量</p><s:property value="#u.numberleft"/></strong>
		          	 <p style="font-size:20px;">需要技术</p><s:property value="#u.language"/></strong>
		          	 <p style="font-size:20px;">城市</p><s:property value="#u.city"/></strong>
		          	  <a href="cchecks?rname=${rname}"><input type="button" value="查看申请者"/></a>
		          	  <a href="crecommend?rname=${rname}&city=${city}&language=${language}"><input type="button" value="推荐的程序员名单"/></a>
		          	 </s:iterator>
		          	 <input type="text" name="phoneNumber" id="phoneNumber" value="" class="form-control form-input" required minlength="11" maxlength="11" isMobilePhoneNumber="true" phoneNumExisting="true"/>
		           </div>
		         </div>
