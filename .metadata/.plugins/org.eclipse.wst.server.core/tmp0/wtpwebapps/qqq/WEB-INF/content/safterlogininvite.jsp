...
<a class="list-group-item" id="navOptions" href="scheckcontract">我的合同</a>
			...
			<div class="col-md-12 phone">
		         ...
		         <div class="col-md-8">
		           <div class="col-lg-7 col-md-7">
		           <s:iterator id="u" value="r">
		            <p style="font-size:20px;">被邀请的项目名称</p><s:property value="#u.pname"/></strong>
		            <p style="font-size:20px;">被邀请的角色</p><s:property value="#u.rname"/></strong>
		          	 <a href="confirm?rname=${rname}"><input type="button" value="接受邀请"/></a>
		          	 </s:iterator>
