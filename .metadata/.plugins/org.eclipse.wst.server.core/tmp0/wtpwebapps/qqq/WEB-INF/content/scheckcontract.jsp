...
二、 双方协商确定，乙方将于2017年12月15日至12月31日在甲方公司工作 　　
三、双方协商确定，乙方在合同期间应完成网站迁移的任务，甲方需按照约定的日薪200元/日给乙方工资。 　　 　　　
四、以上事实清楚，甲乙双方无异议。 　　　　
五、支付方式：____________________________________________________。 　　
...
签订时间：   年 月 日
		           ...
		           <p>
		          	 <p><strong><s:property value="sname"/></strong>是由哈尔滨工业大学本科生<strong><s:property value="sname"/></strong>、汪灵芝和车博轩一起设计和开发的，欢迎大家的使用，并提出建议和指导</p>
						<p>包满意是一个基于<strong><s:property value="sname"/></strong>的互联网软件技术服务平台，您只需要在平台提交软件需求，包满意将会协助您完成需求梳理、技术选型和评估报价，并为您匹配适合该需求的工程师。</p>
						<p>联系方式：email:lzwang@hit.edu.cn</p></div>
		       ...
		       <!--    <div class="col-md-1 col-md-offset-1">
		         ...
		         <div class="col-md-12">
		           <div class="col-lg-12 col-md-12">
		          	 <p>包满意是由哈尔滨工业大学本科生<strong><s:property value="sname"/></strong>、<strong><s:property value="sname"/></strong>和车博轩一起设计和开发的，欢迎大家的使用，并提出建议和指导</p>
						<p>包满意是一个基于<strong><s:property value="sname"/></strong>的互联网软件技术服务平台，您只需要在平台提交软件需求，包满意将会协助您完成需求梳理、技术选型和评估报价，并为您匹配适合该需求的工程师。</p>
						<p>联系方式：email:lzwang@hit.edu.cn</p></div>
