	...
	<form action="AddAction" method="get" class="form-horizontal"
		...
		<fieldset>
			...
			<div class="form-group form-group-a col-md-9">
				...
				<div class="col-md-9">
					<input type="text" class="form-control form-control-a"
						id="projectName" name="c.account" placeholder="" required>
				</div>
			</div>
			...
			<div class="form-group form-group-a col-md-9">
				...
				<div class="col-md-9">
					<input type="text" class="form-control form-control-a"
						id="projectDetail" name="c.password" placeholder="" required>
				</div>
			</div>
			<div class="form-group form-group-a col-md-9">
				<label for="projectName"><i class="form-required">*</i>cname</label><br>
				<div class="col-md-9">
					<input type="text" class="form-control form-control-a"
						id="projectDetail" name="c.cname" placeholder="" required>
				</div>
			</div>
			<div class="form-group form-group-a col-md-9">
				...
				<div class="col-md-9">
					<input type="text" class="form-control form-control-a"
						id="projectDetail" name="c.city" placeholder="" required>
				</div>
			</div>
			<div class="form-group form-group-a col-md-9">
				<label for="projectName"><i class="form-required">*</i>linkman</label><br>
				<div class="col-md-9">
					<input type="text" class="form-control form-control-a"
						id="projectDetail" name="c.linkman" placeholder="" required>
				</div>
			</div>
			<div class="form-group form-group-a col-md-9">
				...
				<div class="col-md-9">
					<input type="text" class="form-control form-control-a"
						id="projectDetail" name="c.phone" placeholder="" required>
				</div>
			</div>
			<div class="form-group form-group-a col-md-9">
				...
				<div class="col-md-9">
					<input type="text" class="form-control form-control-a"
						id="projectDetail" name="c.email" placeholder="" required>
				</div>
			</div>
