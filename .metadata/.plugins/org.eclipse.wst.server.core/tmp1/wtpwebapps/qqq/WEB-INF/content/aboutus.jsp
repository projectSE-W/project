...
<nav id="nav">
	<div class="container">
		...
		<ul class="nav-ul">
	        <li><li><a href="Welcome">首页</a><div></div></li>
			...
			<div class="col-xs-12 aboustUs-body" style="padding:0px;background:url(https://static.make8.com/img/about/aboutusBg.jpg) no-repeat;background-position: center;background-size:cover;">
				...
				<div class="container">
					<div class="col-xs-12 about-content">
						<p>包满意是由哈尔滨工业大学本科生王靖韬、汪灵芝和车博轩一起设计和开发的，欢迎大家的使用，并提出建议和指导</p>
						<p>包满意是一个基于众包的互联网软件技术服务平台，您只需要在平台提交软件需求，包满意将会协助您完成需求梳理、技术选型和评估报价，并为您匹配适合该需求的工程师。</p>
						<p>联系方式：email:lzwang@hit.edu.cn</p>
					</div>
				</div>
