...
<body>
	...
	<nav id="nav">
		<div class="container">
			...
			<ul class="nav-ul">
				<li><a href="Welcome" style="color: black;">首页</a><div></div></li>
					<li class="newDiv"><a href="publish" style="color: black;">发布需求</a><div></div></li>
					<li><a href="projectall"style="color: black;">项目列表</a><div></div></li>
					<li><a href="stoplist"style="color: black;">优秀程序员</a><div></div></li>
					<li><a href="aboutus"style="color: black;">关于我们</a><div></div></li>
					<li id="login_status">
	...
	<form action="sregisterAction" method="get" class="form-horizontal"
		...
		<fieldset>
			...
			<div class="form-group form-group-a col-md-9">
				...
				<div class="col-md-9">
					<input type="text" class="form-control form-control-a"
						id="projectDetail" name="s.name" placeholder="" required>
				</div>
			</div>
			<div class="form-group form-group-a col-md-9">
				<label for="projectName"><i class="form-required">*</i>age</label><br>
				<div class="col-md-9">
					<input type="text" class="form-control form-control-a"
						id="projectDetail" name="s.age" placeholder="" required>
				</div>
			</div>
			<div class="form-group form-group-a col-md-9">
				<label for="projectName"><i class="form-required">*</i>gender</label><br>
				<div class="col-md-9">
					<input type="text" class="form-control form-control-a"
						id="projectDetail" name="s.gender" placeholder="" required>
				</div>
			</div>
			<div class="form-group form-group-a col-md-9">
				<label for="projectName"><i class="form-required">*</i>school</label><br>
				<div class="col-md-9">
					<input type="text" class="form-control form-control-a"
						id="projectDetail" name="s.school" placeholder="" required>
				</div>
			</div>
			<div class="form-group form-group-a col-md-9">
				<label for="projectName"><i class="form-required">*</i>grade</label><br>
				<div class="col-md-9">
					<input type="text" class="form-control form-control-a"
						id="projectDetail" name="s.grade" placeholder="" required>
				</div>
			</div>
