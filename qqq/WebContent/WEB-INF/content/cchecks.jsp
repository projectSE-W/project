...
<div class="col-md-12 phone">
		         ...
		         <div class="col-md-8">
		           ...
		           <s:iterator id="u" value="applicant">
		            <p style="font-size:20px;">手机号码</p><s:property value="#u.account"/></strong>
		            <p style="font-size:20px;">姓名</p><s:property value="#u.name"/></strong>
		          	<p style="font-size:20px;">年龄</p><s:property value="#u.age"/></strong>
		          	 <p style="font-size:20px;">性别</p><s:property value="#u.gender"/></strong>
		          	 <p style="font-size:20px;">学校</p><s:property value="#u.school"/></strong>
		          	 <p style="font-size:20px;">年级</p><s:property value="#u.grade"/></strong>
		          	 <p style="font-size:20px;">专业</p><s:property value="#u.major"/></strong>
		          	 <p style="font-size:20px;">城市</p><s:property value="#u.city"/></strong>
		          	 <p style="font-size:20px;">邮箱</p><s:property value="#u.email"/></strong>
		          	 <p style="font-size:20px;">编程语言</p><s:property value="#u.language"/></strong>
		          	 <a href="confirm?account=${account}"><input type="button" value="确认"/></a>
		          	 </s:iterator>
		          	  
		            
		            
		          	<!--   <p style="font-size:30px;text-align:center"> <a href="cchecks">查看投标的人</a></p>
		          	 <p style="font-size:30px;text-align:center"> <a href="ccheckinvites">推荐的开发人员名单</a></p>
		          	 -->
					...
					<div class="table-responsive">
						<table class="table table-striped">
							...
							<td><strong><s:property value="sid"/></strong></td>
								...
								<td><!-- author_id=${author_id}需要你自己改 -->
									<a href="cdecidewiths?author_id=${author_id}&publisher=${publisher}&publish_date=${publish_date}&price=${price}&title=${title}"><input type="button" value="确定TA"/></a>
								</td>
							</tr>
						...
						<tr>
							...
							<td><strong><s:property value="sid"/></strong></td>
								...
								<td><!-- author_id=${author_id}需要你自己改 -->
									<a href="invitethissAction?author_id=${author_id}&publisher=${publisher}&publish_date=${publish_date}&price=${price}&title=${title}"><input type="button" value="确定TA"/></a>
								</td>
							</tr>
						</s:iterator>
						</table>
