            ...
            <ul class="list-group userInfo-service" id="userinfoNav">
                <a class="header">个人中心</a>
                  ...
                  <input type="hidden" id="tabContentId" value="baseInfo">
                	<a class="list-group-item active" id="navBaseInfo" href="safterlogininformation">基本信息</a>
                	<a class="list-group-item active" id="navBaseInfo" href="safterloginproject">查看所有项目</a>
                	<a href='<s:url action="safterloginproject">
    		</s:url>'></a>
                	
                <a class="list-group-item" id="publishTheProject" href="appliedproject">我投标的项目</a>
                <a class="list-group-item" id="publishTheProject" href="safterlogininvite">被邀请的信息</a>              
<a class="list-group-item" id="navOptions" href="scheckcontract">我的合同</a>
            </ul>
  		  </div>
		     ...
		     <form id="userInfoForm" class="form-horizontal" action="javascript:doSave()" role="form" method="post">
		       ...
		       <div class="col-md-12 phone">
		         ...
		         <div class="col-md-8">
		           ...
		           <s:property value="user.account"/></strong>
		       ...
		       <div class="col-md-12" id="emailDiv">
		         <div class="col-md-3 col-md-offset-1">
		         	<label class="control-label form-label" for="email"><i class="form-required">*</i>密码:</label>
		         </div>
		         <div class="col-md-8">
		          	<div class="col-lg-7 col-md-7">
		          	<s:property value="user.password"/></strong>
		       ...
		       <div class="col-md-12 qq">
		         	...
		         	<div class="col-md-8">
		           		<div class="col-lg-7 col-md-7">
		           		<s:property value="user.name"/></strong>
		       ...
		       <div class="col-md-12 weixin">
		         	<div class="col-md-3 col-md-offset-1">
		           		<label class="control-label form-label" for="phoneNumber"><i class="form-required weixinIconHidden">*</i>年龄:</label>
		         	</div>
		         	<div class="col-md-8">
		           		<div class="col-lg-7 col-md-7">
		           		<s:property value="user.age"/></strong>
		        ...
		        <div class="col-md-12 weixin">
		         	<div class="col-md-3 col-md-offset-1">
		           		<label class="control-label form-label" for="phoneNumber"><i class="form-required weixinIconHidden">*</i>性别:</label>
		         	</div>
		         	<div class="col-md-8">
		           		<div class="col-lg-7 col-md-7">
		           		<s:property value="user.gender"/></strong>
		          	 		<input type="text" name="weixinNumber" id="weixinNumber" value="" class="form-control form-input"/>
		           		</div>
		          	</div>
		        </div>
		        ...
		        <div class="col-md-12 weixin">
		         	<div class="col-md-3 col-md-offset-1">
		           		<label class="control-label form-label" for="phoneNumber"><i class="form-required weixinIconHidden">*</i>学校:</label>
		         	</div>
		         	<div class="col-md-8">
		           		<div class="col-lg-7 col-md-7">
		           		<s:property value="user.school"/></strong>
		          	 		<input type="text" name="weixinNumber" id="weixinNumber" value="" class="form-control form-input"/>
		           		</div>
		          	</div>
		        </div>
		        ...
		        <div class="col-md-12 weixin">
		         	<div class="col-md-3 col-md-offset-1">
		           		<label class="control-label form-label" for="phoneNumber"><i class="form-required weixinIconHidden">*</i>年级:</label>
		         	</div>
		         	<div class="col-md-8">
		           		<div class="col-lg-7 col-md-7">
		           		<s:property value="user.grade"/></strong>
		          	 		<input type="text" name="weixinNumber" id="weixinNumber" value="" class="form-control form-input"/>
		           		</div>
		          	</div>
		        </div>
		        ...
		        <div class="col-md-12 weixin">
		         	<div class="col-md-3 col-md-offset-1">
		           		<label class="control-label form-label" for="phoneNumber"><i class="form-required weixinIconHidden">*</i>专业:</label>
		         	</div>
		         	<div class="col-md-8">
		           		<div class="col-lg-7 col-md-7">
		           		<s:property value="user.major"/></strong>
		          	 		<input type="text" name="weixinNumber" id="weixinNumber" value="" class="form-control form-input"/>
		           		</div>
		          	</div>
		        </div>
		        ...
		        <div class="col-md-12 weixin">
		         	...
		         	<div class="col-md-8">
		           		<div class="col-lg-7 col-md-7">
		           		<s:property value="user.city"/></strong>
		          	 		<input type="text" name="weixinNumber" id="weixinNumber" value="" class="form-control form-input"/>
		           		</div>
		          	</div>
		        </div>
		        ...
		        <div class="col-md-12 weixin">
		         	<div class="col-md-3 col-md-offset-1">
		           		<label class="control-label form-label" for="phoneNumber"><i class="form-required weixinIconHidden">*</i>电话:</label>
		         	</div>
		         	<div class="col-md-8">
		           		<div class="col-lg-7 col-md-7">
		           		<s:property value="user.phone"/></strong>
		          	 		<input type="text" name="weixinNumber" id="weixinNumber" value="" class="form-control form-input"/>
		           		</div>
		          	</div>
		        </div>
		        ...
		        <div class="col-md-12 weixin">
		         	<div class="col-md-3 col-md-offset-1">
		           		<label class="control-label form-label" for="phoneNumber"><i class="form-required weixinIconHidden">*</i>邮箱:</label>
		         	</div>
		         	<div class="col-md-8">
		           		<div class="col-lg-7 col-md-7">
		           		<s:property value="user.email"/></strong>
		          	 		<input type="text" name="weixinNumber" id="weixinNumber" value="" class="form-control form-input"/>
		           		</div>
		          	</div>
		        </div>
		        ...
		        <div class="col-md-12 weixin">
		         	<div class="col-md-3 col-md-offset-1">
		           		<label class="control-label form-label" for="phoneNumber"><i class="form-required weixinIconHidden">*</i>编程语言（用‘，’隔开）:</label>
		         	</div>
		         	<div class="col-md-8">
		           		<div class="col-lg-7 col-md-7">
		           		<s:property value="user.language"/></strong>
		          	 		<input type="text" name="weixinNumber" id="weixinNumber" value="" class="form-control form-input"/>
		           		</div>
		          	</div>
		        </div>
